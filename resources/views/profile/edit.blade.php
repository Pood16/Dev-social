    ...
    <nav class="bg-white shadow-md w-full z-10">
        <div class="container w-9/12 mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4 bg-amber-300 p-1 rounded">
                    <a href="{{route('profile')}}" class="text-white font-medium">
                    ...
                    <div class="flex flex-col md:flex-row gap-8 mb-8 mt-10">
                        ...
                        <div class="w-full md:w-2/3">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea id="bio" rows="3" class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50 transition-colors duration-300" name="bio" required>{{ trim($user->bio ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
